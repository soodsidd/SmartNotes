...
/**
 * Large-PDF paint harness — production bundle + isolated e2e vault.
 * Rendering assertions start after pager is live (client paint, not network).
 */
...
export default defineConfig({
  testDir: "./e2e",
  testMatch: "**/sn-151-large-pdf-paint.spec.ts",
  timeout: 600_000,
  fullyParallel: false,
  workers: 1,
  reporter: [["list"]],
